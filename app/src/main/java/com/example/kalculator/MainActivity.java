    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.button_clear:
                if (addOperand("")) equalClicked = false;
                if (textViewInputNumbers.getText().length() > 1) {
                    mExpression = (String) textViewInputNumbers.getText().subSequence(0, (textViewInputNumbers.getText().length() - 1));
                } else {
                    mExpression = "";
                    textViewInputNumbers.setText("");
                }
                textViewInputNumbers.setText(mExpression);
                dotUsed = false;
                equalClicked = false;
                break;
    ...
    private boolean addOperand(String operand) {
        ...
        if (operationLength > 0) {
            ...
            if ((lastInput.equals("+") || lastInput.equals("-") || lastInput.equals("*") || lastInput.equals("\u00F7") || lastInput.equals("%"))) {
                ...
                textViewInputNumbers.getText().subSequence(0, textViewInputNumbers.length() - 1);
            }
        } else {
